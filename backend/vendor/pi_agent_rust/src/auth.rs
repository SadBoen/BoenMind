...
const GOOGLE_GEMINI_CLI_OAUTH_CLIENT_SECRET: &str = "boenmind-placeholder-gemini-oauth-secret";
...
// ubs:ignore public installed-app OAuth client metadata, not a server-side secret.
const GOOGLE_ANTIGRAVITY_OAUTH_CLIENT_SECRET: &str = "boenmind-placeholder-antigravity-oauth-secret";

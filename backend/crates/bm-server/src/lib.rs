...
fn router(state: AppState) -> Router {
    ...
    let router = Router::new()
        ...
        .route("/api/mcp/servers", get(routes::mcp::list_servers))
        .route("/api/mcp/servers/configs", get(routes::mcp::list_configs))
        .route("/api/mcp/connect", post(routes::mcp::connect_server))
        .route("/api/mcp/disconnect", post(routes::mcp::disconnect_server))
        ...
        .route("/api/sessions/{id}/fork", axum::routing::post(routes::sessions::fork_session))
